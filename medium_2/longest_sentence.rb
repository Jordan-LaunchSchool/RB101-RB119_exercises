=begin
	...
	and then prints the longest sentence based on number of words
...
ALGO:
	...
	- sort the array of sentences by size, small to large
	- split the last element of the array into words

	- print the size of the last element.



=end

def lonest_sentence(input_string)
	sorted_sentences = input_string.split(/\.|\?|!/).sort_by do |sentence|
		sentence.size
	end
	longest_string = sorted_sentences.last
	largest_word_count = longest_string.split(' ').size
	p longest_string
	p largest_word_count
end

lonest_sentence('Four score and seven years ago our fathers brought forth
...
lonest_sentence('The Project Gutenberg eBook of Frankenstein; Or, The Modern Prometheus
